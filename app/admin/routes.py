...
Gestión de licencias, clientes y configuración
"""
...
def licenses_list():
    ...
    # Query base con join a customer
    ...
    # Ordenar por fecha de expiración (las más próximas primero)
...
def license_new():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Crear business config por defecto si no existe
...
def license_renew(license_id):
    ...
    try:
        # Calcular nueva fecha (desde hoy, no desde expiración anterior)
        hoy = datetime.utcnow()
...
def customer_new():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Crear business config por defecto
            config = BusinessConfig(
